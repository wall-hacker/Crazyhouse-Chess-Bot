...
class Bot {
 ...
 public:
  ...
  /* debug */
  void printStatus(PlaySide sideToMove, PlaySide engineSide, Move* move, struct state currentState);
  //////////

  void simulateRecordMove(int& auxDest, Move* move, PlaySide sideToMove, int board[8][8]);
